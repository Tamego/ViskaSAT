...
#let js(
  lang: "ja",
  seriffont: "Fira Sans",
  seriffont-cjk: "M PLUS 1p",
  sansfont: "Fira Sans",
  sansfont-cjk: "M PLUS 1p",
  paper: "a5", // "a*", "b*", or (paperwidth, paperheight) e.g. (210mm, 297mm)
  fontsize: 10pt,
  baselineskip: auto,
  ...
  book: true,
  cols: 1,
  non-cjk: "latin-in-cjk", // or "latin-in-cjk"
  ...
  show raw: set text(font: "M+CodeLat60 Nerd Font")
  set par(
